 ...
 * between jumpcoind, and jumpcoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Jumperbillijumper/jumpcoin>";
    const std::string URL_WEBSITE = "<https://jumpcoin.net/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Jumpcoin Developers", 2023)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Jumpcoin useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Jumpcoin More version %s\n", FormatFullVersion());
}
