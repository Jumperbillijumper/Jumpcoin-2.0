...
#if defined(NDEBUG)
# error "Jumpcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Jumpcoin Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("jumpcoin-scriptch");
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Jumpcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Jumpcoin also requires low S in sigs
